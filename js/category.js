    ...
    $("#category-form").on("submit", function(e){
        ...
        $.ajax({
            ...
            error: function(xhr, status, error) {
                ...
                console.error('URL attempted:', domain + "category/add.php");
                console.error('Status:', xhr.status);
    ...
    $(document).on("click", ".view_category", function(){
        ...
        $.ajax({
            ...
            error: function(xhr, status, error) {
                ...
                console.error('URL attempted:', domain + "category/view.php");
    ...
    $(document).on("click", ".edit_category", function(){
        ...
        $.ajax({
            ...
            error: function(xhr, status, error) {
                ...
                console.error('URL attempted:', domain + "category/edit.php");
    ...
    $("#update-category-form").on("submit", function(e){
        ...
        $.ajax({
            ...
            error: function(xhr, status, error) {
                ...
                console.error('URL attempted:', domain + "category/update.php");
            ...
            if (result.isConfirmed) {
                $.ajax({
                    ...
                    error: function(xhr, status, error) {
                        ...
                        console.error('URL attempted:', domain + "category/delete.php");
